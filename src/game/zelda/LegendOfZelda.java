...
public class LegendOfZelda extends Game {
	...
	public void start() {
		...
		// SoundBank.getInstance().set("title_screen", new LoopingSound("sounds/bg/LoZ Oracle of Seasons Intro + Title Screen.WAV"));
		SoundBank.getInstance().set("main_theme", new LoopingSound("sounds/bg/LoZ Oracle of Seasons Main Theme.WAV"));
		SoundBank.getInstance().set("sword_slash1", new SoundEffect("sounds/effects/Oracle_Sword_Slash1.wav"));
		SoundBank.getInstance().set("boomerang", new LoopingSound("sounds/effects/Oracle_Boomerang.wav"));
		SoundBank.getInstance().set("enemy_hit", new SoundEffect("sounds/effects/Oracle_Enemy_Hit.wav"));
		SoundBank.getInstance().set("enemy_die", new SoundEffect("sounds/effects/Oracle_Enemy_Die.wav"));
		SoundBank.getInstance().set("link_hurt", new SoundEffect("sounds/effects/Oracle_Link_Hurt.wav"));
		SoundBank.getInstance().set("link_die", new SoundEffect("sounds/effects/Oracle_Link_Dying.wav"));
		SoundBank.getInstance().set("link_low_life", new LoopingSound("sounds/effects/Oracle_LowHealth.wav"));
		SoundBank.getInstance().set("link_get_rupee", new SoundEffect("sounds/effects/Oracle_Get_Rupee.wav"));
		SoundBank.getInstance().set("link_get_rupee5", new SoundEffect("sounds/effects/Oracle_Get_Rupee5.wav"));
		SoundBank.getInstance().set("link_get_heart", new SoundEffect("sounds/effects/Oracle_Get_Heart.wav"));
		SoundBank.getInstance().set("link_get_item", new SoundEffect("sounds/effects/Oracle_Get_Item.wav"));
		SoundBank.getInstance().set("link_get_heart_container", new SoundEffect("sounds/effects/Oracle_HeartContainer.wav"));
		SoundBank.getInstance().set("tune_of_ages", new SoundEffect("sounds/effects/OOA_Harp_TuneOfAges.wav"));
		SoundBank.getInstance().set("open_chest", new SoundEffect("sounds/effects/Oracle_Chest.wav"));
		SoundBank.getInstance().set("secret", new SoundEffect("sounds/effects/Oracle_Secret.wav"));
		SoundBank.getInstance().set("menu_cursor", new SoundEffect("sounds/effects/Oracle_Menu_Cursor.wav"));
		SoundBank.getInstance().set("menu_select", new SoundEffect("sounds/effects/Oracle_Menu_Select.wav"));	
